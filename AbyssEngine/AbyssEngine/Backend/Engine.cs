...
namespace AbyssEngine.Backend
{
    public sealed class Engine : Game
    {
        ...
        private readonly IContentLoadPass[] _contentLoadPasses;

        public Engine(IGameEntryPoint gameEntryPoint, IContentLoadPass[] contentLoadPasses = null)
        {
            if (_singleton != null)
            ...
            _contentLoadPasses = contentLoadPasses;
        }
        ...
        {
            if (_contentLoadPasses != null)
                _contentLoader.AddContentLoadPasses(_contentLoadPasses);
